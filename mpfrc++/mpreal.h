...
public:
    ...
    std::string to_string(int n = -1, int b = 10, mp_rnd_t mode = mpreal::get_default_rnd()) const;
...
inline std::string mpreal::to_string(const std::string& format) const
{
    char *s = NULL;
    std::string out;
...
inline std::string mpreal::to_string(int n, int b, mp_rnd_t mode) const
{
...
inline mpf_class cast2mpf_class(const mpreal &b) {
    ...
    mpfr_set(tmp2, a.mpfr_ptr(), mpreal::default_rnd);
